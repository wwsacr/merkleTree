...
public class merkleTree extends JFrame {
    ...
    JTextField entryText1 = new JTextField();
    JTextField entryText2 = new JTextField();
    JTextField entryText3 = new JTextField();
    JTextField entryText4 = new JTextField();
    JTextField entryText5 = new JTextField();
    JTextField entryText6 = new JTextField();
    JTextField entryText7 = new JTextField();
    JTextField entryText8 = new JTextField();
